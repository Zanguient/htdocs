...
{	
	...
	public static function gravar(_12020 $obj)
	{
        //
	}
	...
	public static function alterar(_12020 $obj)
	{
        //
	}
    ...
    public static function exibirEmpresa(_Conexao $con, _12020 $obj) {
        ...
        "
            ...
            FROM
                ...
                WHERE
                    E.CODIGO > 0
                AND E.HABILITA_REPRESENTANTE = '1'
                /*STATUS*/
                )X
