...
/**
 * Controller do objeto _22010 - Consulta de Financeiro
 */
class _20120Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'financeiro/_20120';
    ...
    public function distribuirQuantidade($itens,$saldo, $callback) {
        ...
        foreach ($itens as $item ) {
            ...
            validator($item, [
                ...
                'TALAO_GP_CCUSTO'                   => ['C.Financeiro do Grupo de Produção do Talão'         ,'required'],
            ],true);                 
    ...
    public function processarEtiquetas($item, _20120 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W20120']);
