 ...
 */
class _22160Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'ppcp/_22160';
    ...
    public function distribuirQuantidade($itens,$saldo, $callback) {
        ...
        foreach ($itens as $item ) {
            ...
            validator($item, [
                ...
                'TALAO_UP_CCUSTO'                   => ['C.Custo do Grupo de Produção do Talão'         ,'required'],
            ],true);                 
    ...
    public function processarEtiquetas($item, _22160 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W22160']);
        ...
        foreach ( $itens_ean as $item_ean ) {
            ...
            $str_talao = str_replace('#CAMPO1#', $item_ean->MODELO_DESCRICAO , $str_talao);                      
            $str_talao = str_replace('#COR1#'  , $item_ean->COR_DESCRICAO    , $str_talao);                      
