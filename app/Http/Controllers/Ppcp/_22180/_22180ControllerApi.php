...
use App\Http\Controllers\Ppcp\_22180\_22180Controller as Ctrl;
...
/**
 * Controller do objeto _22180 - Geracao de Remessas de Bojo
 */
class _22180ControllerApi extends Ctrl {
    ...
    public function getTalao() {
        ...
        try {     
            ...
            $dto_22180 = new _22180($this->con());

            $ret = $dto_22180->selectTalao($request);
    ...
    public function getTaloesComposicao() {
        ...
        try {     
            ...
            $ret = $dto_22180->getTaloesComposicao($request);
    ...
    public function getTalaoComposicao() {
        ...
        try {     
            ...
            $ret = $dto_22180->getTalaoComposicao($request);
    ...
    public function sse() {
        ...
        $sse->emitEvent(function() use ($sse, $request) {
            ...
            try {
                ...
                $dto_22180 = new _22180($con);
                
                $sse->setValues($dto_22180->getTaloesComposicao($request));
                
                $dto_22180->__destruct();
    ...
    public function postTaloesAcao($tipo) {
        ...
        try {     
            ...
            foreach ( $dados->ITENS as $talao ) {
                ...
                $talao->ULTIMO_TALAO       = isset($dados->TALAO->ULTIMO_TALAO) && $dados->TALAO->ULTIMO_TALAO == true ? true : false;
...
//                            break;
    ...
    //                        $talao->ESTACAO_TALAO_ID             = 0;
                    ...
                    $dto_22180->postTalaoAcao($talao);
                }
                
                $etiquetas->ETIQUETA = $etiquetas->ETIQUETA . $this->processarEtiquetas($talao,$dto_22180);
            }
            
            $ret = (object) [];
            
            if ( isset($request->FILTRO) ) {
                $ret->DATA_RETURN = $dto_22180->getTaloesComposicao($request->FILTRO);
        ...
        try {     
            ...
            foreach ( $transacoes as $transacao ) {
                switch ($transacao->TIPO) {
                    case 'AVULSO':
                        $dto_22180->deleteTransacaoAvulsa($transacao);
                        break;
                    case 'PEÇA':
                        $dto_22180->deleteTransacaoPeca($transacao);
                        break;
                }
            }            
            ...
            if ( isset($request->FILTRO) ) {
                $ret->DATA_RETURN = [
                    'DADOS'  => $dto_22180->selectProdutoPpcpMinimo($request->FILTRO),
                    'TRANSACOES' => $dto_22180->selectTransacao($request->FILTRO_TRANSACAO)
                ];
            }
...
//            $this->con()->rollback();
    ...
    public function getConsumoBaixado() {
        ...
        try {     
            ...
            $consumos = $dto_22180->selectConsumo($request);
    ...
    public function getConsumoBaixadoTransacao() {
        ...
        try {     
            ...
            $consumos = $dto_22180->selectTransacao($request);
    ...
    public function postConsumoBaixadoTransacaoDelete() {
        ...
        try {     
            ...
            foreach ( $transacoes as $transacao ) {
                ...
                $dto_22180->deleteTransacao($transacao); 
                $dto_22180->updateConsumo((object) [
            ...
            if ( isset($request->FILTRO) ) {
                $ret->DATA_RETURN = [
                    'DADOS'      => $dto_22180->selectConsumo  ($request->FILTRO),
                    'TRANSACOES' => $dto_22180->selectTransacao($request->FILTRO_TRANSACAO)
                ];
            }
    ...
    public function getEtiqueta() {
        ...
        try {     
            ...
            foreach ( $itens as $item ) {
                ...
                $etiquetas = $etiquetas . $this->processarEtiquetas($item,$dto_22180);                
