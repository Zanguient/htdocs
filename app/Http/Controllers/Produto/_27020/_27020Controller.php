 ...
 */
class _27020Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'produto/_27020';
    ...
    public function processarEtiquetas($item, _27020 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W27020']);
