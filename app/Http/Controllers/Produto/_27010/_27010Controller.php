 ...
 */
class _27010Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'produto/_27010';
    ...
    public function processarEtiquetas($item, _27010 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W27010']);
