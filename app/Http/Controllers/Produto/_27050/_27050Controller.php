...
/**
 * Controller do objeto _22010 - Consulta de Produto
 */
class _27050Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'produto/_27050';
    ...
    public function processarEtiquetas($item, _27050 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W27050']);
