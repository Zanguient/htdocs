...
use App\Models\DTO\Vendas\_12020;
...
class _12020Controller extends Controller
{
...
//     			exit('anexo');
    ...
    public function pesquisa(Request $request)
    {
    	if( $request->ajax() ) {
    		...
    		$empresas = _12020::pesquisaEmpresa($obj);
    ...
    public function paginacaoScroll(Request $request)
    {
    	/*if ( $request->ajax() ) {
    		...
    		$dados = _12020::paginacaoScroll($request->get('qtd_por_pagina'), $request->get('pagina'));
    		...
    		if( !empty($dados) ) {
    			...
    			foreach ($dados as $dado) {
    				...
    				$res .= '<tr link="http://'.$_SERVER['HTTP_HOST'].'/Vendas/_12020/'.$dado->ID .'">';
    				$res .= '<td>'.$dado->ID.'</td>';
    ...
    public function filtraObj(Request $request)
    {
    	/*if ( $request->ajax() ) {
    		...
    		$dados = _12020::filtraObj($request->get('filtro'));
