...
class _14010Controller extends Controller
{
...
//     			exit('anexo');
    ...
    public function pesquisa(Request $request)
    {
    	if( $request->ajax() ) {
    		...
    		$empresas = _14010::pesquisaEmpresa($obj);
    ...
    public function paginacaoScroll(Request $request)
    {
    	/*if ( $request->ajax() ) {
    		...
    		$dados = _14010::paginacaoScroll($request->get('qtd_por_pagina'), $request->get('pagina'));
    		...
    		if( !empty($dados) ) {
    			...
    			foreach ($dados as $dado) {
    				...
    				$res .= '<tr link="http://'.$_SERVER['HTTP_HOST'].'/Logistica/_14010/'.$dado->ID .'">';
    				$res .= '<td>'.$dado->ID.'</td>';
    ...
    public function filtraObj(Request $request)
    {
    	/*if ( $request->ajax() ) {
    		...
    		$dados = _14010::filtraObj($request->get('filtro'));
