 ...
 */
class _31020Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'custo/_31020';
    ...
    public function processarEtiquetas($item, _31020 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W31020']);
