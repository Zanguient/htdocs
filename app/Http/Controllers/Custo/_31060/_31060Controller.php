 ...
 */
class _31060Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'custo/_31060';
    ...
    public function processarEtiquetas($item, _31060 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W31060']);
