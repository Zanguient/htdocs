 ...
 */
class _31040Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'custo/_31040';
    ...
    public function processarEtiquetas($item, _31040 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W31040']);
