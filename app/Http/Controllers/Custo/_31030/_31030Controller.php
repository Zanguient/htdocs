 ...
 */
class _31030Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'custo/_31030';
    ...
    public function processarEtiquetas($item, _31030 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W31030']);
