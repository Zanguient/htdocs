 ...
 */
class _11200Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'admin/_11200';
    ...
    public function processarEtiquetas($item, _11200 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W11200']);
