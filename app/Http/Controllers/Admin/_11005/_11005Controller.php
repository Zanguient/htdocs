 ...
 */
class _11005Controller extends UserControl {
	
	/**
     * Código do menu
     * @var int 
     */
    public $menu = 'admin/_11005';
    ...
    public function processarEtiquetas($item, _11005 $dto) {
        
        $etiqueta = $dto->selectEtiqueta((object)['ETIQUETA_TIPO' => 'W11005']);
