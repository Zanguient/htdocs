@extends('helper.include.view.modal', ['id' => 'modal-imobilizado-item-parcela', 'class_size' => 'modal-lg'])
...
@section('modal-body')
    <div class="table-ec" style="max-height: calc(100vh - 160px);">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr ng-repeat="parcela in vm.ImobilizadoItem.PARCELAS">
                    <td class="text-center">@{{ parcela.PARCELA | lpad : [3,0] }}</td>
