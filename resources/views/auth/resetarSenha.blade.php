...
<body>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Altere sua senha no sistema</div>
						<div class="panel-body">
					
							<form method="POST" action="/resetarSenha" url-redirect="/home" class="form-horizontal js-gravar">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
								
								<div class="form-group">
									<label class="control-label">Usuário</label>
									<input type="text" class="form-control" name="usuario" id="usuario" required autofocus autocomplete="off" />
								</div>
								
								<div class="form-group">
									<label class="control-label">Senha anterior</label>
									<input type="password" class="form-control" name="password_old" id="password-old" required />
								</div>
	...
	<script src="{{ elixir('assets/js/resetarSenha.js') }}"></script>
