    ...
    <div class="conteiner-cortador">
        <div class="turno1-producao">
            <div class="bsc1 font-ajustavel2">Corte</div>
            <div class="bsc2 font-ajustavel2">1º TURNO</div>
            <div class="bsc3 font-ajustavel2">2º TURNO</div>
        </div>
        ...
        <div class="tab-title">
            <div class="tab-title1">Produção</div>
            <div class="tab-title1">Produção</div>
        </div>

        <div class="tab-corte">
            <div class="item-corte">
                <div class="item-corte1 font-corte font-corte1">
                    1500
                </div>
                <div class="item-corte1">
                    <div class="tab-title2">
                        <div class="tab-title4 font-corte3">Eficiência</div>
                        <div class="tab-title5 font-corte3">Pedas</div>
                    </div>
                    <div class="item-corte2 font-corte font-corte2">
                        98.5%
                    </div>
                    <div class="item-corte3 font-corte font-corte2">
                        5%
                    </div>
                </div>
            </div>
            <div class="item-corte">
                ...
                <div class="item-corte1">
                    <div class="tab-title2">
                        <div class="tab-title4 font-corte3">Efic.</div>
                        <div class="tab-title5 font-corte3">Pedas</div>
                    </div>
                    <div class="item-corte2 font-corte font-corte2">
                        98.5%
    ...
    <div class="perdas-producao2 font-ajustavel2"></div>
    <div class="perdas-producao3 font-ajustavel2 tcenter">M. HORA</div>
    <div class="perdas-producao4 font-ajustavel2"></div>
