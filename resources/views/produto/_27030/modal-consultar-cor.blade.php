	...
	<form class="form-inline">
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input 
						type="search" 
						class="form-control input-maior input-filtrar-cor" 
						placeholder="{{ Lang::get($menu.'.placeholder-filtrar') }}" 
						autocomplete="off" 
						ng-model="$ctrl.filtrarCor" 
					/>
		...
		<div class="row">
			...
			<div class="form-group">	
				...
				@include('produto._27030.modal-consultar-cor-table')
