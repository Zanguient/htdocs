...
<ul class="list-inline acoes">
    <li>
		<button type="button" class="btn btn-success btn-autorizar-oc {{ $autorizar_oc ? 'autorizar-oc' : '' }}" data-hotkey="alt+a" data-loading-text="{{ Lang::get('master.gravando') }}" {{ $autorizar_oc ? '' : 'disabled' }}>
			<span class="glyphicon glyphicon-ok"></span>
			 {{ Lang::get('compras/_13050.autorizar-oc') }}
		</button>
	</li>
    <li>
		<button type="button" class="btn btn-danger btn-negar-oc {{ $autorizar_oc ? 'negar-oc' : '' }}" data-hotkey="alt+n" data-loading-text="{{ Lang::get('master.gravando') }}" {{ $autorizar_oc ? '' : 'disabled' }}>
			<span class="glyphicon glyphicon-ban-circle"></span>
			 {{ Lang::get('compras/_13050.negar-oc') }}
		</button>
	</li>
    @if ( $oc->AUTORIZACAO == 2  && $controle == 1 )
    <li>
		<button type="button" class="btn btn-primary enviar-oc" data-hotkey="alt+e" data-loading-text="{{ Lang::get('master.enviando') }}">
			<span class="glyphicon glyphicon-send"></span>
			 {{ Lang::get('compras/_13050.enviar-oc') }}
		</button>
	</li>
	<li>
    ...
    <li>
		<a href="{{ url($referencia, $oc->REFERENCIA_ID) }}" target="_blank" class="btn btn-default btn-ref" data-hotkey="alt+r">
    ...
    @endif
    <li>
		<a href="{{ url('_13050') }}" class="btn btn-default btn-voltar" data-hotkey="f11">
...
@include('helper.include.view.historico',['tabela' => 'TBOC', 'id' => $id, 'no_button' => 'true'])
