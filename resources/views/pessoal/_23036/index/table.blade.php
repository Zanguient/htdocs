<div class="table-ec table-base">
	...
	<table class="table table-bordered table-header">
		...
		<tbody vs-repeat vs-scroll-parent=".table-ec">
			<tr 
				tabindex="0"
				ng-repeat="base in $ctrl.Index.listaAvaliacaoBase | orderBy : 'ID' : true | filter : $ctrl.filtroTabela track by $index"
				ng-click="$ctrl.Index.exibirBase(base)" 
				ng-keypress="$event.keyCode == 13 ? $ctrl.Index.exibirBase(base) : null">
