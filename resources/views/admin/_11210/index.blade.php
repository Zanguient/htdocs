...
@section('estilo')
    <link rel="stylesheet" href="{{ elixir('assets/css/11210.css') }}" />
@endsection
...
<div ng-controller="Ctrl as vm" ng-cloak>
        ...
        <table class="table table-striped table-bordered table-condensed table-no-break table-middle table-low">
            ...
            <tbody>
                <tr 
                    ...
                    <td>
                        <span ng-if="item.STATUS == 1">Ativo</span>
                        <span ng-if="item.STATUS != 1">Inativo</span>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    @include('admin._11210.modal_incluir')
    @include('admin._11210.modal_incluir_itens')
    @include('admin._11210.modal_menu')
    @include('admin._11210.modal_grupo')

</div>
@endsection

@section('script')
    <script src="{{ elixir('assets/js/_11210.js') }}"></script>
@append
