...
@section('titulo')
    {{ Lang::get('ppcp/_22200.titulo') }}
@endsection

@section('estilo')
    <link rel="stylesheet" href="{{ elixir('assets/css/22200.css') }}" />
@endsection
...
<div ng-controller="Ctrl as vm" ng-cloak>
    ...
    @include('ppcp._22200.index.panel-destaque')
    ...
    <fieldset class="tab-container" style="margin-top: 10px;">
        ...
        <div id="tab-content" class="tab-content">
            ...
            @include('ppcp._22200.index.tab.tab-container-liberar')
            @include('ppcp._22200.index.tab.tab-container-consulta')
        </div>
    ...
    @include('ppcp._22200.index.modal-operador')
    @include('ppcp._22200.index.modal-gp')
</div>
@endsection

@section('script')
    <script src="{{ elixir('assets/js/_22200.js') }}"></script>
@append
