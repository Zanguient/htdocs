        ...
        <page size="A4">
            <section id="top">
                <div class="center">
                    ...
                    <label>Relatório de Consumo de Remessa</label>
                    <label>Remessa {{ $remessa->REMESSA }} / Data Remessa: {{ date('d/m/Y', strtotime($remessa->DATA)) }} / Grupo de Produção: {{ $remessa->GP_ID }} - {{ $remessa->GP_DESCRICAO }} </label>
                </div>
                <div class="right">
