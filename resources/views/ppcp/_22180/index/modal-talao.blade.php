...
@section('modal-body')
    ...
    <div
        ng-if="vm.TalaoProduzir.check('finalizar').descricao != ''" 
    ...
    ">
		...
		<button 
            ...
            id="etiqueta" 
            data-hotkey="alt+i" 
            ng-disabled="!vm.TalaoProduzir.check('etiqueta').status"    
            ng-click="vm.TalaoProduzir.acao('etiqueta')"
            >
...
<!--        <button ng-click="vm.Acoes.justInefic(vm.MODAL)" type="button" class="btn btn-temp btn-warning">
    ...
    <fieldset>
        <legend>Talão @{{ vm.Talao.SELECTED.PROGRAMACAO_STATUS_DESCRICAO }}
...
<!--                    <td class="um">@{{ vm.Talao.SELECTED.TEMPO_PREVISTO | number : 2 }} min</td>
    ...
    @include('ppcp._22180.index.modal-talao.detalhe')
    @include('ppcp._22180.index.modal-talao.consumo')
    @include('ppcp._22180.index.modal-talao.historico')
@overwrite