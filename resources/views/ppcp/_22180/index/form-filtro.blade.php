...
>
    ...
    <div id="form-filtro" class="table-filter collapse in" aria-expanded="true">
		...
		<div class="form-group filtro-periodo">
            ...
            <input 
                disabled
                ng-model="vm.Filtro.DATA_TODOS" 
                style="top: -2px; margin-left: 7px; vertical-align: middle; width: 20px !important;" 
                type="checkbox" 
                id="periodo-todos" 
                class="form-control periodo-todos" 
                title="Só é utilizado em Talões à Produzir" 
                checked>
