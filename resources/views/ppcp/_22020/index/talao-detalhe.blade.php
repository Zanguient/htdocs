<fieldset class="detalhe">
	...
	<div class="botao-container">
		...
		@if ( isset($p211) && $p211 === '1' )
		<button type="button" class="btn btn-sm btn-warning" id="registrar-aproveitamento" title="{{ Lang::get($menu.'.registrar-aproveitamento') }}" data-hotkey="alt+p" data-toggle="modal" data-target="#modal-registrar-aproveitamento" disabled>
			<span class="glyphicon glyphicon-edit"></span>
			{{ Lang::get($menu.'.registrar-aproveitamento') }}
		</button>
		@endif

		@if ( isset($p203) && $p203 === '1' )
		<button type="button" class="btn btn-sm btn-success" id="qtd-gravar-todos" title="{{ Lang::get($menu.'.gravar-todos') }}" data-hotkey="alt+g" disabled>
