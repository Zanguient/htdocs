@extends('helper.include.view.modal', ['id' => 'modal-separacao', 'class_size' => 'modal-lg'])

@section('modal-start')
    <form class="form-inline" name="confirmarEntrada" ng-submit="vm.Ferramenta.ConfirmarSeparacao()">
@overwrite

@section('modal-header-left')

	<h4 class="modal-title">
		Confirmação Separação da Ferramenta
	</h4>
