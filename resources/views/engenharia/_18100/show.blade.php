...
<ul class="list-inline acoes">
    ...
    <li><a href="{{ $permissaoMenu->INCLUIR ? url('/_13010/create') : '#' }}" class="btn btn-primary" {{ $permissaoMenu->INCLUIR ? '' : 'disabled' }} ><span class="glyphicon glyphicon-plus" ></span> {{ Lang::get('master.incluir') }}</a></li>

	<li class="pesquisa-obj-container">
