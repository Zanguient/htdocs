@extends('helper.include.view.modal', ['id' => 'modal-detalhar-despesa2', 'class_size' => 'modal-full'])
...
@section('modal-body')
    ...
    <button type="button" style="margin: 1px;" class="btn btn-primary" ng-click="vm.export1('tabela-despesa4','Despesa.csv')">
        <span class="glyphicon glyphicon-save"></span> 
        Exportar para CSV
    </button>

    <button type="button" style="margin: 1px;" class="btn btn-primary" ng-click="vm.export2('tabela-despesa4','Despesa.xls')">
        <span class="glyphicon glyphicon-save"></span> 
        Exportar para XLS
    </button>

    <button type="button" style="margin: 1px;" class="btn btn-primary" ng-click="vm.Imprimir('div-despesa4','Detalhamento de Despesa / ' + vm.Item.DESPESA_ITEM.DESCRICAO)">
        <span class="glyphicon glyphicon-print"></span> 
        Imprimir
    </button>

    <div class="table-ec" style="height: 75%; margin-top: 5px;" id="div-despesa4">
        <div class="scroll-table">
            <table class="table table-striped table-bordered table-hover tabela-itens-caso table-body table-lc table-lc-body table-consumo" id="tabela-despesa4">
                <thead>
                    <tr style="background-color: #3479b7;">
                        <th>
                        </th>

                        <th title="Centro de Custo" ng-click="vm.Ficha.OrdemD3('ORIGEM')">
                        ...
                        <th title="Centro de Custo" ng-click="vm.Ficha.OrdemD3('DESCRICAO')">
                        ...
                        <th title="Centro de Custo" ng-click="vm.Ficha.OrdemD3('PERCENTUAL')">
                        ...
                        <th title="Colaborador" ng-click="vm.Ficha.OrdemD3('VALOR')">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="iten in vm.Item.DESPESA_DETALHE | orderBy:vm.Ficha.OrdemDespesa3"
                        ...
                        <td class="left-text" ng-if="iten.ORIGEM != '31100400001'" >@{{(iten.PERCENTUAL * (vm.Item.DESPESA_ITEM.PERCENTUAL/100)) | number:6}}</td>
                        <td class="left-text" ng-if="iten.ORIGEM == '31100400001' && iten.TIPO == 4" >@{{(iten.PERCENTUAL) | number:6}}</td>
                        <td class="left-text" ng-if="iten.ORIGEM == '31100400001' && iten.TIPO != 4" >@{{vm.Item.DESPESA_ITEM.PERCENTUAL | number:6}}</td>
